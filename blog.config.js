...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ZAX', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '番茄好吃捏', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.coacervate.org/', // 网站地址
